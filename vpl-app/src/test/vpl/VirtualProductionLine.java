...
//    Color backgroundColour = new Color(153,153,153);
	...
	vplToolBar.add(exportBatchButton);
        ...
        coolpic = new PicPanel(directoryPrefix + picString);
        coolpic.validate();
...
/*    void showVisual(String visualURLString){
    ...
    boolean clearPicturePane(){
    	...
    	String fn = directoryPrefix + "images" + System.getProperty("file.separator") + "VPL4_Intro.jpg";
        switch(batchStatus){
        	case -2:
       	 	fn = directoryPrefix + "images" + System.getProperty("file.separator") + "VPL4_Intro.jpg"; break;
	        case -1:
	       	 	fn = directoryPrefix + "images" + System.getProperty("file.separator") + "VPL4_Intro.jpg"; break;
	        case 0:
	        	 fn = directoryPrefix + "images" + System.getProperty("file.separator") + "VPL4_Intro"
                                 + ""
                                 + ".jpg"; break;
	        case 1:
